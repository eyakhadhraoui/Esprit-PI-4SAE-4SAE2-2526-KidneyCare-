...
public class AlimentService {
    ...
    private static final String ALIMENT_NOT_FOUND = "Aliment non trouvé";
    ...
    public AlimentDTO updateAliment(Long id, AlimentDTO dto) {
        Aliment aliment = alimentRepository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, ALIMENT_NOT_FOUND));
    ...
    public void deleteAliment(Long id) {
        if (!alimentRepository.existsById(id)) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, ALIMENT_NOT_FOUND);
        }
