...
export type TypeEventCalendrier = 'SUIVI' | 'IMAGE_MEDICALE' | 'TEST_DEMANDE' | 'TEST_REALISE' | 'RAPPORT_BILAN';
...
export class CalendrierService {
  ...
  private mapEvent(dto: any): CalendrierEvent {
    const rawType = dto.type ?? 'SUIVI';
    const type: TypeEventCalendrier =
      rawType === 'IMAGE_MEDICALE' || rawType === 'TEST_DEMANDE' || rawType === 'TEST_REALISE' || rawType === 'RAPPORT_BILAN'
        ? rawType
        : 'SUIVI';
    return {
