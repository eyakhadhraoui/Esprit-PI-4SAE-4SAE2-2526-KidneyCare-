...
public class InfectionService {
    ...
    public List<Exercise> getExercises() {
        return exerciseServiceClient.getAllExercises();
    }

    public Exercise getExerciseById(int id) {
        return exerciseServiceClient.getExerciseById(id);
    }


    public Infection save(Infection infection) {
    ...
    public Optional<Infection> findById(Long id) {
